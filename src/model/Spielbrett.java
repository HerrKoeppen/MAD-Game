...
public class Spielbrett {
    ...
    /**
     * array mit allen moeglichen farben, die reinfolge ist folgende:
     * Blau, Rot, GrÃ¼n, Pink,  Gelb, Schwarz, Braun
     * und wird bei allen möglichen funktionen so übernommen
     * die farbe eines spielers ist spielbrett[spieler.id];
     */
     ...
     * 
     * Aufbau:
     * das spielbrett ist eine Stern mit 7 Zacken 
     * jede ZAckenspitze ist ein A-Feld einer anderen Farbe
     * zwischen den A Feldern liegen genau 7/5 andere normale Felder
     *  d. h. jede seite des sterns ist Funf/Vier seiten lang 
     * die ZAcken sind gefüllt mit den zielfeldern (haeusern) 
     * rechts neben jeder Zacken sind die 3/4 Startfelder
     * in der mitte liegt der Würfel : die aktAugenzahl
     * 
     * 
     * Hier ein paar ideen im Vergleich:
     * ein Normales spiel(4 personen und 40-43 Felder) würde 
     * ohne doppelt wüfeln und rauskommen bzw. schlagen und blockiert sein
     * einen erwartungswert von ca. 48 runden und 190 zügen haben.
     * 1. version:
     * das spielbrett ist eine Stern mit 7 Zacken 
     * ZAcke:             
     *                a    s s    
     ...
     *             n  z  n 
     * Figuren: 3
     * Felder:  42-44 (7*6+ zielfelder)
     * E(Runden): ca. 37
     * E(Züge): ca. 258
     * 
     * Nachteil: wenn man nach dem Rauskojmmen eine 6 würfelt 
     * Vorteil :das spiel ist ein mittelmas von einer gemäßigten spiellänge (zugzahl), runden
